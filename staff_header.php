...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <div class="collapse navbar-collapse" id="topNav">
        ...
        <ul class="navbar-nav ms-2">
            <li class="nav-item">
                <a class="nav-link <?= ($current_page == 'staff_dashboard.php') ? 'active' : '' ?>" href="staff_dashboard.php">Staff Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($current_page == 'staff_sales_report.php') ? 'active' : '' ?>" href="staff_sales_report.php">Sales Report</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($current_page == 'staff_settings.php') ? 'active' : '' ?>" href="staff_settings.php">Settings</a>
            </li>
        </ul>
